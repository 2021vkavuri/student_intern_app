...
export default function PrefRoutesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAircraft(initialValues.aircraft);
    setDirection(initialValues.direction);
    setSeq(initialValues.seq);
    setDCNTR(initialValues.DCNTR);
    setACNTR(initialValues.ACNTR);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new PrefRoutes(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "PrefRoutesCreateForm")}
      {...rest}
    >
      <TextField
        label="Origin"
